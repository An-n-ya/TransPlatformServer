...
import com.app.search.SearchResult;
import com.app.search.SearchService;
...
/**
 * 管理后台搜索控制器 — 按类别搜索（user / topic / ...）
 */
@RestController
@RequestMapping("/admin/v1/search")
@RequiredArgsConstructor
@Validated
@Tag(name = "管理后台-搜索", description = "管理员按类别搜索用户、话题等")
public class AdminSearchController {

    private final SearchService searchService;

    @GetMapping
    @Operation(summary = "管理员按类别搜索")
